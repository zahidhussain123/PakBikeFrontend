...
class OpenRentAd extends React.Component {
  constructor() {
    super();
  ...
  data.image = "http://localhost:3000/uploads/1629692330111rentaaa.jpg";
    data["image2"] = "http://localhost:3000/uploads/1629692330111rentaaa.jpg";
    data["image3"] = "http://localhost:3000/uploads/1629692330111rentaaa.jpg";
    // data["image3"] = "http://localhost:3000/uploads/1620240156330download.jpg";
    return (
      <div>
        <div className="back_openad_back">
          ...
          <div className="back_left_add">
                ...
                <Slide>
                  ...
                  <div className="each-slide">
                    <div
                      className="img_slider_control"
                      style={{
                        backgroundImage: `url(${data.image3})`,
                      }}
                    ></div>
                  </div>
                </Slide>
            ...
            <div className="box_des_bottom_slider">
              ...
              <div className="model_openad">
                <span className="all_heading_openad">Model : </span>
                {data.model}
              </div>
              <div className="millage_openad">
                <span className="all_heading_openad">Millage : </span>
                {data.millage}
              </div>
          ...
          <div className="back_right_add">
            ...
            <div className="postad_openad">
              <a href="/Postadd">
                <button class="post_ad_openad button3">Post Free Ad +</button>
              </a>
            </div>
          </div>
