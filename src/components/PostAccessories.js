      ...
      <div className="container">
        <div className="full_page">
          <div className="small_add">
            <div className="head_add">Bike Accessories Information</div>
            <div class="add_form">
              <form onSubmit={(e) => accessAd(e)}>
                {/* title */}
                ...
                <label className="box_text" for="category">
                  Category
                </label>
                <div className="post_box_control2">
                  <select id="inputCategory" name="country">
...
function accessAd(e) {
  ...
  let request = {
    ...
    categories: document.getElementById("inputCategory").value,
  ...
  axios
    .post("http://localhost:3000/Accessories/AccessAdd", request)
    .then((resp) => {
